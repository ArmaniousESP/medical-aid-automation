      ...
      <div className="mx-auto max-w-3xl px-4 py-10 space-y-10">
        <header className="space-y-2">
          ...
          <p className="text-slate-600" dir="rtl">
            خطوتان للمستفيد · خطوات للموظفين بعد فتح التشغيل
          </p>
        </header>
        ...
        <section className="space-y-4">
          <div className="rounded-xl border-2 border-emerald-200 bg-emerald-50 p-4">
            ...
            <p className="text-sm text-emerald-800 mt-1" dir="rtl">
              للمستفيدين والموظفين — بدون تسجيل دخول
            </p>
            ...
            {PUBLIC_STEPS.map((s) => (
              ...
              >
                ...
                <div className="space-y-2 min-w-0 flex-1">
                  ...
                  <Link
                    href={s.href}
                    className="inline-flex mt-1 rounded-lg bg-emerald-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-emerald-700"
                  >
                    {s.cta} →
                  </Link>
                </div>
        ...
        <section className="space-y-4">
          <div className="rounded-xl border-2 border-violet-200 bg-violet-50 p-4">
            ...
            <p className="text-sm text-violet-800 mt-1" dir="rtl">
              لفريق التشغيل — بعد فتح القفل بكلمة السر
            </p>
            ...
            {STAFF_STEPS.map((s) => (
              ...
              >
                ...
                <div className="space-y-2 min-w-0 flex-1">
                  ...
                  <Link
                    href={s.href}
                    className="inline-flex mt-1 rounded-lg bg-violet-700 px-3 py-1.5 text-xs font-medium text-white hover:bg-violet-800"
                  >
                    {s.cta} →
                  </Link>
                </div>
        ...
        <section className="rounded-xl border bg-white p-5 shadow-sm space-y-3 text-sm">
          ...
          <ul className="list-disc list-inside space-y-2 text-slate-600">
            ...
            <li>
              Programs, claims, pharmacy, and full lists require unlock with{' '}
              <code className="text-xs bg-slate-100 px-1 rounded">PROCESS_SECRET</code>.
            </li>
            <li dir="rtl">
              البيانات التفصيلية للمرضى غير معروضة للعامة.
            </li>
          </ul>
        </section>
